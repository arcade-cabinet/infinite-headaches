...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorScreenOrientation", path: "../../../node_modules/.pnpm/@capacitor+screen-orientation@8.0.0_@capacitor+core@8.0.2/node_modules/@capacitor/screen-orientation"),
